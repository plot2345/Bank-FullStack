...
const useStyles = makeStyles((theme) => ({
    root: {                                ///state me styling send eale pr yeah lge
      '& > *': {
...
export default function CreateUser(){
    ...
    const matchesSM = useMediaQuery(theme.breakpoints.down('sm')); //matrial ui
    ...
    const Push = (e) => {
        ...
        db.collection("users").add({ //databse me request bhej rha hai
            name: name,
            email: email,
            phone: phone,
            amount: amount
